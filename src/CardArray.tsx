...
export const CardArray: GameLensType[] = [
  {
    name: "1",
    index: 1,
    title: "Emotion",
    cardTitle: "The Lens of Emotion",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Essential Experience",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    index: 4,
    title: "Surprise",
    cardTitle: "The Lens of Surprise",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    index: 6,
    title: "Curiosity",
    cardTitle: "The Lens of Curiosity",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    name: "7",
    index: 7,
    title: "Endogenous Value",
    cardTitle: "The Lens of Endogenous Value",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Problem Solving",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of The Elemental Tetrad",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Holographic Design",
    suitlist: ["Process"],
    description:
  ...
  },
  {
    ...
    index: 11,
    title: "Unification",
    cardTitle: "The Lens of Unification",
    suitlist: ["Process"],
    description:
  ...
  },
  {
    ...
    index: 12,
    title: "Resonance",
    cardTitle: "The Lens of Resonance",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Infinite Inspiration",
    suitlist: ["Process"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of The Problem Statement",
    suitlist: ["Process"],
    description:
  ...
  },
  {
    name: "15",
    index: 15,
    title: "The Eight Filters",
    cardTitle: "The Lens of The Eight Filters",
    suitlist: ["Process"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Risk Mitigation",
    suitlist: ["Process"],
    description:
  ...
  },
  {
    ...
    index: 19,
    title: "The Player",
    cardTitle: "The Lens of The Player",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    index: 23,
    title: "Motivation",
    cardTitle: "The Lens of Motivation",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    index: 25,
    title: "Judgment",
    cardTitle: "The Lens of Judgment",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Functional Space",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of The State Machine",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 29,
    title: "Secrets",
    cardTitle: "The Lens of Secrets",
    suitlist: ["Experience", "Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Expected Value",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 37,
    title: "Fairness",
    cardTitle: "The Lens of Fairness",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 38,
    title: "Challenge",
    cardTitle: "The Lens of Challenge",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Meaningful Choices",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 40,
    title: "Triangularity",
    cardTitle: "The Lens of Triangularity",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    name: "41",
    index: 41,
    title: "Skill vs Chance",
    cardTitle: "The Lens of Skill vs Chance",
    suitlist: ["Game"],
    description:
    ...
    questionlist: [
      ...
      "Skill tends to be more serious that chance: Is my game serious or casual?",
      "Are parts of my game tedious?  If so, will adding elements of chance enliven them?",
      "Do parts of my game feel too random?  If so, will replacing elements of chance with elements of skill and strategy make the players feel more in control?"
    ],
  ...
  },
  {
    ...
    cardTitle: "The Lens of Head and Hands",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 43,
    title: "Competition",
    cardTitle: "The Lens of Competition",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 44,
    title: "Cooperation",
    cardTitle: "The Lens of Cooperation",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Competition vs Cooperation",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 47,
    title: "Punishment",
    cardTitle: "The Lens of Punishment",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Simplicity / Complexity",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 49,
    title: "Elegance",
    cardTitle: "The Lens of Elegance",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 50,
    title: "Character",
    cardTitle: "The Lens of Character",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 51,
    title: "Imagination",
    cardTitle: "The Lens of Imagination",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    index: 54,
    title: "Accessibility",
    cardTitle: "The Lens of Accessibility",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Visible Progress",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 56,
    title: "Parallelism",
    cardTitle: "The Lens of Parallelism",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 57,
    title: "The Pyramid",
    cardTitle: "The Lens of The Pyramid",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 58,
    title: "The Puzzle",
    cardTitle: "The Lens of The Puzzle",
    suitlist: ["Game"],
    description:
    ...
    questionlist: [
      "What the are the puzzles in my game?",
  ...
  },
  {
    ...
    cardTitle: "The Lens of Physical Interface",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Virtual Interface",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 62,
    title: "Transparency",
    cardTitle: "The Lens of Transparency",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 63,
    title: "Feedback",
    cardTitle: "The Lens of Feedback",
    suitlist: ["Game", "Player"],
    description:
  ...
  },
  {
    ...
    index: 64,
    title: "Juiciness",
    cardTitle: "The Lens of Juiciness",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 65,
    title: "Primality",
    cardTitle: "The Lens of Primality",
    suitlist: ["Game", "Player"],
    description:
  ...
  },
  {
    name: "66",
    index: 66,
    title: "Channels and Dimensions",
    cardTitle: "The Lens of Channels and Dimensions",
    suitlist: ["Game"],
    description:
    ...
    questionlist: [
      ...
      "Which dimensions are available on each channels?",
  ...
  },
  {
    ...
    cardTitle: "The Lens of Interest Curve",
    suitlist: ["Experience"],
    description:
    ...
    questionlist: [
      ...
      "Is there a fractural structure to my interest curve?  Should there be?",
  ...
  },
  {
    name: "70",
    index: 70,
    title: "Inherent Interest",
    cardTitle: "The Lens of Inherent Interest",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    index: 72,
    title: "Projection",
    cardTitle: "The Lens of Projection",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    index: 73,
    title: "Story Machine",
    cardTitle: "The Lens of Story Machine",
    suitlist: ["Experience"],
    description:
    ...
    questionlist: [
      ...
      "Does this game produce stories with good interest curves?",
      "Are players excited to tell the story of what happened in the game?"
    ],
  ...
  },
  {
    ...
    index: 74,
    title: "Obstacle",
    cardTitle: "The Lens of Obstacle",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    name: "75",
    index: 75,
    title: "Simplicity and Transcendence",
    cardTitle: "The Lens of Simplicity and Transcendence",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of The Hero's Journey",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of The Weirdest Thing",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Indirect Control",
    suitlist: ["Game", "Player"],
    description:
  ...
  },
  {
    ...
    index: 82,
    title: "Collusion",
    cardTitle: "The Lens of Collusion",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 83,
    title: "Fantasy",
    cardTitle: "The Lens of Fantasy",
    suitlist: ["Experience", "Player"],
    description:
  ...
  },
  {
    ...
    index: 84,
    title: "The World",
    cardTitle: "The Lens of The World",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    index: 85,
    title: "The Avatar",
    cardTitle: "The Lens of The Avatar",
    suitlist: ["Player", "Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Character Function",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Character Traits",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Interpersonal Circumplex",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    name: "89",
    index: 89,
    title: "The Character Web",
    cardTitle: "The Lens of The Character Web",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Character Transformation",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    name: "92",
    index: 92,
    title: "Inner Contradiction",
    cardTitle: "The Lens of Inner Contradiction",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    name: "93",
    index: 93,
    title: "The Nameless Quality",
    cardTitle: "The Lens of The Nameless Quality",
    suitlist: ["Experience"],
    description:
...

  {
    ...
    index: 94,
    title: "Atmosphere",
    cardTitle: "The Lens of Atmosphere",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    index: 95,
    title: "Spectation",
    cardTitle: "The Lens of Spectation",
    suitlist: ["Game"],
    description:
...

  {
    ...
    index: 96,
    title: "Friendship",
    cardTitle: "The Lens of Friendship",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    index: 97,
    title: "Expression",
    cardTitle: "The Lens of Expression",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    index: 98,
    title: "Community",
    cardTitle: "The Lens of Community",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    index: 99,
    title: "Griefing",
    cardTitle: "The Lens of Griefing",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    index: 101,
    title: "The Team",
    cardTitle: "The Lens of The Team",
    suitlist: ["Designer"],
    description:
  ...
  },
  {
    ...
    index: 102,
    title: "Documentation",
    cardTitle: "The Lens of Documentation",
    suitlist: ["Designer", "Player"],
    description:
  ...
  },
  {
    ...
    index: 103,
    title: "Playtesting",
    cardTitle: "The Lens of Playtesting",
    suitlist: ["Designer", "Player"],
    description:
  ...
  },
  {
    ...
    index: 104,
    title: "Technology",
    cardTitle: "The Lens of Technology",
    suitlist: ["Game"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of The Crystal Ball",
    suitlist: ["Experience"],
    description:
    ...
    questionlist: [
      "What will __________ be like two years from now?  Why?",
      "What will __________ be like four years from now?  Why?",
      "What will __________ be like ten years from now?  Why?"
    ],
  ...
  },
  {
    ...
    index: 106,
    title: "Utopia",
    cardTitle: "The Lens of Utopia",
    suitlist: ["Experience", "Designer"],
    description:
  ...
  },
  {
    ...
    index: 107,
    title: "The Client",
    cardTitle: "The Lens of The Client",
    suitlist: ["Designer"],
    description:
  ...
  },
  {
    ...
    index: 108,
    title: "The Pitch",
    cardTitle: "The Lens of The Pitch",
    suitlist: ["Designer"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Transformation",
    suitlist: ["Player"],
    description:
  ...
  },
  {
    ...
    cardTitle: "The Lens of Responsibility",
    suitlist: ["Designer"],
    description:
  ...
  },
  {
    ...
    index: 112,
    title: "The Raven",
    cardTitle: "The Lens of The Raven",
    suitlist: ["Designer"],
    description:
  ...
  },
  {
    name: "113",
    index: 113,
    title: "Your Secret Purpose",
    cardTitle: "The Lens of Your Secret Purpose",
    suitlist: ["Designer"],
    description:
  ...
  },
  {
    ...
    index: 114,
    title: "Presence",
    cardTitle: "The Lens of Presence",
    suitlist: ["Experience"],
    description:
  ...
  },
  {
    ...
    index: 115,
    title: "Cheatability",
    cardTitle: "The Lens of Cheatability",
    suitlist: ["Player"],
    description:
